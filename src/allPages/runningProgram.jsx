          ...
          <div className="running-text-content">
            ...
            <div className="text running-popup-text">
              <ul className="better-runs-types">
                ...
                <li className="text running-type">	.מתגברות בסוף הריצה- קטעי ריצה קצרים (עד 100 מטר) בהם יתורגל קצב ריצה מהיר, ביצוע המתגברות יהיה באופן הבא: 20 שניות ריצה מתגברת שלאחריה 40 שניות ריצה קלה מאוד</li>
              </ul>
            </div>
          </div>
        </div>
